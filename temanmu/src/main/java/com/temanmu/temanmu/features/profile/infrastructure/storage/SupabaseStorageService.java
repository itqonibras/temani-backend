package com.temanmu.temanmu.features.profile.infrastructure.storage;
...
public class SupabaseStorageService {
	...
	public SupabaseStorageService(@Value("${temanmu.supabase.url}") String supabaseUrl,
			@Value("${temanmu.supabase.serviceRoleKey}") String serviceRoleKey,
			@Value("${temanmu.supabase.storage.bucket}") String bucketName) {
