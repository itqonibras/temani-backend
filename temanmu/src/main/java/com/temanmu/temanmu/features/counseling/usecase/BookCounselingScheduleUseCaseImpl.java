...
public class BookCounselingScheduleUseCaseImpl implements BookCounselingScheduleUseCase {
    ...
    public CounselingScheduleResponse execute(UUID scheduleId, UUID clientId) {
        ...
        if (scheduleEntity.getStatus() != com.temanmu.temanmu.common.enums.CounselingScheduleStatus.AVAILABLE) {
        ...
        scheduleEntity.setStatus(com.temanmu.temanmu.common.enums.CounselingScheduleStatus.AVAILABLE);
