...
public class UpdateCounselingScheduleUseCaseImpl implements UpdateCounselingScheduleUseCase {
    ...
    public CounselingScheduleResponse execute(UUID scheduleId, UUID requesterId, CounselingScheduleRequest request) {
        ...
        if (existing.getStatus() == null) {
            existing.setStatus(com.temanmu.temanmu.common.enums.CounselingScheduleStatus.SCHEDULED);
        }
        ...
        if (oldStatus != com.temanmu.temanmu.common.enums.CounselingScheduleStatus.COMPLETED &&
                saved.getStatus() == com.temanmu.temanmu.common.enums.CounselingScheduleStatus.COMPLETED) {
            try {
