package com.temanmu.temanmu.features.payment.domain.repository;
...
public interface PaymentRepository {
    ...
    List<Payment> findByScheduleIdAndStatus(UUID scheduleId, com.temanmu.temanmu.common.enums.PaymentStatus status);
