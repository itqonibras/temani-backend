...
import com.temani.temani.features.payment.domain.repository.PaymentRepository;
...
public class PaymentServiceImpl implements PaymentService {
    ...
    @Value("${temani.payment.maxFee:1000000.00}")
    private BigDecimal maxFee;

    @Value("${temani.payment.midtrans.serverKey}")
    ...
    public PaymentResponse createPayment(PaymentRequest request) {
        try {
            ...
            if (schedule.getStatus() != com.temani.temani.common.enums.CounselingScheduleStatus.AVAILABLE) {
            ...
            if (schedule.getClient() == null) {
                ...
                schedule.setStatus(com.temani.temani.common.enums.CounselingScheduleStatus.AVAILABLE);
